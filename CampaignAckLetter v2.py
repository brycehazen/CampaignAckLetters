...
column_mapping = {
    'Gf_CnBio_ID': 'EConstituent ID',
    'Gf_CnBio_Anonymous': 'EIs Anonymous?',
    'Gf_CnBio_Title_1': 'ETitle',
    'Gf_CnBio_Gender': 'EGender',
    'Gf_CnBio_Deceased': 'EIs Deceased?',
    'Gf_CnBio_Inactive': 'EIs Inactive?',
    'Gf_CnBio_First_Name': 'EFirst Name',
    'Gf_CnBio_Last_Name': 'ELast Name',
    'Gf_CnBio_Marital_status': 'EMarital Status',
    'Gf_CnBio_No_Valid_Addresses': 'ENo Valid Addresses?',
    'Gf_CnSpSpBio_ID': 'ESpouse ID',
    'Gf_CnSpSpBio_Anonymous': 'ESpouse Is Anonymous?',
    'Gf_CnSpSpBio_Title_1': 'ESpouse Title',
    'Gf_CnSpSpBio_Gender': 'ESpouse Gender',
    'Gf_CnSpSpBio_Deceased': 'ESpouse Deceased?',
    'Gf_CnSpSpBio_Inactive': 'ESpouse Inactive?',
    'Gf_CnSpSpBio_First_Name': 'ESpouse First Name',
    'Gf_CnSpSpBio_Last_Name': 'ESpouse Last Name',
    'Gf_CnSpSpBio_Marital_status': 'ESpouse Marital Status',
    'Gf_CnAdrSal_Addressee': 'EAddressee',
    'Gf_CnAdrSal_Salutation': 'ESalutation',
    'Gf_CnAdrPrf_Addrline1': 'EAddress Line 1',
    'Gf_CnAdrPrf_Addrline2': 'EAddress Line 2',
    'Gf_CnAdrPrf_City': 'ECity',
    'Gf_CnAdrPrf_State': 'EState',
    'Gf_CnAdrPrf_ZIP': 'EZIP Code'
